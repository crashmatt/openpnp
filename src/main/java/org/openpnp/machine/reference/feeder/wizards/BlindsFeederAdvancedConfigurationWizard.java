...
public class BlindsFeederAdvancedConfigurationWizard extends AbstractConfigurationWizard {
    private final BlindsFeederAdvanced feeder;
    ...
    public BlindsFeederAdvancedConfigurationWizard(BlindsFeederAdvanced feeder) {
        this.feeder = feeder;
        ...
        comboBoxCoverType = new JComboBox(BlindsFeederAdvanced.CoverType.values());
        ...
        comboBoxCoverActuation = new JComboBox(BlindsFeederAdvanced.CoverActuation.values());
            ...
            UiUtils.messageBoxOnException(() -> {
                ...
                if (j.showOpenDialog(getTopLevelAncestor()) == JFileChooser.APPROVE_OPTION) {
                    ...
                    for (String fileName : new String[] { "BlindsFeeder-Library.scad", "BlindsFeeder-3DPrinting.scad" }) {
                        String fileContent = IOUtils.toString(BlindsFeederAdvanced.class
    ...
    private Action openAllCovers = new AbstractAction("Open All Covers") {
        ...
        public void actionPerformed(ActionEvent e) {
            applyAction.actionPerformed(e);
            UiUtils.submitUiMachineTask(() -> {
            	BlindsFeederAdvanced.actuateAllFeederCovers(MainFrame.get().getMachineControls().getSelectedNozzle(), true);
            });
        }
    };
    ...
    private Action closeAllCovers = new AbstractAction("Close All Covers") {
        ...
        public void actionPerformed(ActionEvent e) {
            applyAction.actionPerformed(e);
            UiUtils.submitUiMachineTask(() -> {
            	BlindsFeederAdvanced.actuateAllFeederCovers(MainFrame.get().getMachineControls().getSelectedNozzle(), false);
            });
        }
    };
